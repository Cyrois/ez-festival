...
import TeamGroupsPanel from './TeamGroupsPanel.vue';
...
const page = usePage();
const event = computed(() => props.event ?? page.props.activeEvent ?? {});
    ...
    >
        <div class="container mx-auto max-w-6xl">
            ...
            <Tabs v-model="activeTab">
                <TabList>
                    <Tab value="teams">
                        {{ $t('team.configure.tabs.teams') }}
                    </Tab>
                    <Tab value="shifts">
                        {{ $t('team.configure.tabs.shifts') }}
                    </Tab>
                </TabList>
                        ...
                        >
                            <aside class="w-full shrink-0 lg:w-[220px]">
                                ...
                                <p class="mb-3 text-xs text-muted">
                                    {{
                                        $t(
                                            'team.configure.locations.manage_hint',
                                        )
                                    }}
                                </p>
                            ...
                            <div class="min-w-0 flex-1">
                                <div
                                    class="mb-3.5 flex flex-wrap items-center gap-2.5"
                                >
                                ...
                                >
                                    ...
                                    >
                                        <h3
                                            class="m-0 mb-1.5 text-[15px] font-bold"
                                        >
                                            {{ template.name }}
                                        </h3>
                                        <p
                            ...
                            >
                                <div>
                                    <h3 class="m-0 text-base font-bold">
                                        {{
                                            $t(
                                                'team.configure.shift_roles.title',
                                            )
                                        }}
                                    </h3>
                                    <p class="mt-1 mb-0 text-xs text-muted">
                                        {{
                                            $t(
                                                'team.configure.shift_roles.lead',
                                            )
                                        }}
                                    </p>
                                </div>
                                ...
                                >
                                    ...
                                    <template v-if="canWrite">
                                        <IconButton
                                            ...
                                            :label="
                                                $t(
                                                    'team.configure.shift_roles.edit',
                                                )
                                            "
                                            tone="edit"
                                            class="!h-7 !w-7"
                                        ...
                                        <IconButton
                                            ...
                                            :label="
                                                $t(
                                                    'team.configure.shift_roles.delete',
                                                )
                                            "
                                            tone="delete"
                                            class="!h-7 !w-7"
