...
<template>
    ...
    <div class="flex min-h-screen bg-page text-charcoal antialiased">
        <aside
            class="flex w-[200px] shrink-0 flex-col border-r border-line bg-white px-2 py-3"
        >
            <div class="mb-3 flex items-center gap-2 px-1.5 py-1">
                ...
                <div class="min-w-0">
                    <strong class="block truncate text-[11px] font-bold">{{
                        $t('app.name')
                    }}</strong>
        ...
        <div class="flex min-w-0 flex-1 flex-col">
            <div
                class="flex h-9 items-center border-b border-line px-4 text-[10px] text-muted"
            >
                {{ crumb }}
            </div>
