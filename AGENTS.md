...
- Compose screens from `resources/js/components/ui` (Button, Input, Textarea, Select, Checkbox, Radio, Switch, Badge, Label, Tag, FormField, Toast, Icon, …). Do not one-off restyle controls per page. Extend the kit in a PR when something is missing.
